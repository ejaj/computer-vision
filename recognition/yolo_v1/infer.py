...
from recognition.yolo_v1.visualization_utils import *
...
def infer(args):
    path = "/home/kazi/Works/Dtu/computer-vision/recognition/yolo_v1/samples"
    ...
    for i in tqdm(range(num_samples)):
        ...
        # Visualization #
        #################
        path_v = "/home/kazi/Works/Dtu/computer-vision/recognition/yolo_v1/samples/preds"
        if not os.path.exists(path_v):
            os.mkdir(path_v)
        path_g = "/home/kazi/Works/Dtu/computer-vision/recognition/yolo_v1/samples/grid_cls"
        ...
        cv2.imwrite(path_v + '{}_pred.jpeg'.format(i), out_img)
        ...
        cv2.imwrite(path_g + '{}_grid_map.jpeg'.format(i), res)
