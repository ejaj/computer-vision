...
print(
    f"The reprojection error in camera 1 is {error_q1_nonlin:.1f} pixels and it is {error_q2_nonlin:.2f} pixels in camera 2.")
print(f"The distance between Q and Q_tilde_nonlin is {distance_Q_nonlin:.3f}")
